# -*- coding: utf-8 -*-
"""Money Modeling software. ver. share

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1tdtK02lWuHv5Vcow_2SbPEAmQ6E45zDm
"""
...
class EntryType(Enum):
    ...
    INTRADAY_IOU = "intraday_iou" # Add a new type to record intraday iou
...
class SettlementDetails:
    ...
    is_intraday: bool = False # A label for it
...
class Agent:
    def __init__(self, name: str, agent_type: AgentType):
        ...
        if self.type == AgentType.BANK:
            ...
            self.intraday_module.system = self.system
        self.reserves: float = 0.0
        self.customer_deposits: Dict[str, float] = {} # Deposit for transaction
    ...
    def transfer_customer_deposit(sender_bank, receiver_bank, customer_a, customer_b, amount):
    ...
    def _handle_default(self, iou_entry, time_point):
        ...
        try:
            ...
            emergency_loan = AssetLiabilityPair(
                ...
                maturity_date=None,
                settlement_type=SettlementType.MEANS_OF_PAYMENT,
                settlement_denomination=iou_entry.denomination,
                asset_holder=self.bank,
                liability_holder=cb
            )
        ...
        if entry_type_choice == 1:
            ...
            if type_idx == 2:  # receivable-payable
                ...
                if issuer_agent.get_net_worth() <= 0:
                  print(f"Error: Issuer {issuer_agent.name} has insufficient net worth ({issuer_agent.get_net_worth()})")
                  return
                ...
                if existing_shares:
                    print(f"Error: {asset_holder.name} already holds shares from {issuer_agent.name}.")
                    return
